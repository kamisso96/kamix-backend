...
export interface ApiBusinessSolutionBusinessSolution
  extends Struct.CollectionTypeSchema {
  collectionName: 'business_solutions';
  info: {
    displayName: 'business-solution';
    pluralName: 'business-solutions';
    singularName: 'business-solution';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::business-solution.business-solution'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiEducationProgramEducationProgram
  extends Struct.CollectionTypeSchema {
  collectionName: 'education_programs';
  info: {
    displayName: 'education-program';
    pluralName: 'education-programs';
    singularName: 'education-program';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::education-program.education-program'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::business-solution.business-solution': ApiBusinessSolutionBusinessSolution;
      'api::education-program.education-program': ApiEducationProgramEducationProgram;
